    ...
    Dialog(onDismissRequest = onDismiss) {
        Surface(
            ...
            Column(
                ...
                Text(
                    text = "Are you sure you want to delete ${retainedTopics.size} retained message(s) under /$branchPath/#? This sends 0-byte retained payloads to remove them permanently from the broker.",
                    fontSize = 13.sp,
                    color = DarkOnSurfaceVariant,
                    lineHeight = 18.sp
                )
