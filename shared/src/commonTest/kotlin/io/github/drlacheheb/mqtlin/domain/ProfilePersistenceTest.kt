...
class ProfilePersistenceTest {
    @Test
    fun `getAllProfiles returns initial stored profiles`() =
        runTest {
    ...
    @Test
    fun `saveProfile inserts new profile and updates last selected`() =
        runTest {
            val repository = FakeProfileRepository()
            val newProfile =
                ConnectionConfig(
    ...
    @Test
    fun `saveProfile with existing name updates existing profile without duplicating`() =
        runTest {
            val repository = FakeProfileRepository()
            val updated =
                ConnectionConfig(
    ...
    @Test
    fun `deleteProfile removes profile and updates last selected if needed`() =
        runTest {
            val repository = FakeProfileRepository()
    ...
    @Test
    fun `exportProfilesJson exports JSON and respects password exclusion flag`() =
        runTest {
            val repository = FakeProfileRepository()
            val secretProfile =
                ConnectionConfig(
    ...
    @Test
    fun `importProfilesJson parses JSON and merges profiles`() =
        runTest {
            val repository = FakeProfileRepository()
            val jsonPayload =
                """
