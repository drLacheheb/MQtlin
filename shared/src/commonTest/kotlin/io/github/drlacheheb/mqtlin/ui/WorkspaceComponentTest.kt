...
class WorkspaceComponentTest {
    ...
    @Test
    fun `initial workspace state starts with empty topic tree and connected config`() =
        runTest {
    ...
    @Test
    fun `incoming MQTT message from repository is inserted into topic tree state`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
    ...
    @Test
    fun `selecting topic updates selectedTopicPath and selectedNode in state`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
    ...
    @Test
    fun `selecting directory node updates selectedTopicPath and selectedNode with children in state`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
    ...
    @Test
    fun `toggling node expansion updates topic tree state`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
            ...
            val initialNode =
                component.state.value.rawTopicTree
                    .findNode("home")
    ...
    @Test
    fun `filtering topic tree queries only matching branches`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
    ...
    @Test
    fun `publishing message invokes repository and updates topic tree`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
    ...
    @Test
    fun `publishing message with blank topic is ignored`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
    ...
    @Test
    fun `publishing message with leading slash automatically trims prefix and publishes clean topic path`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
            ...
            val node =
                component.state.value.rawTopicTree
                    .findNode("home/living-room/temperature")
            node.shouldNotBeNull()
    ...
    @Test
    fun `accumulating multiple messages under the same topic updates message count and last message`() =
        runTest {
            val (component, lifecycle) = createComponent(this)
    ...
    @Test
    fun `disconnecting from repository triggers onDisconnect callback`() =
        runTest {
    ...
    @Test
    fun `clicking onOpenConnectionManager triggers callback`() =
        runTest {
    ...
    @Test
    fun `clicking onOpenSettings triggers callback`() =
        runTest {
